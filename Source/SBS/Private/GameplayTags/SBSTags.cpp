...
namespace SBSTags
{
	...
	namespace Events
	{
		...
		namespace Player
		{
			UE_DEFINE_GAMEPLAY_TAG_COMMENT(HitReact, "SBSTags.Events.Player.HitReact", "Tag for Player HitReact Event.");
			UE_DEFINE_GAMEPLAY_TAG_COMMENT(Death, "SBSTags.Events.Player.Death", "Tag for Player Death Event.");
		}
